...
export const IconPalette: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><circle cx="12" cy="12" r="10"/><path d="M12 2a10 10 0 0 0-4.472 18.156"/><path d="M16 10a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z"/><path d="M13 14a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z"/><path d="M9 14a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z"/></svg>
);

export const IconSparkles: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M9.938 2.009a10 10 0 1 1-4.242 19.38"/><path d="m2.008 14.062 4.38-4.38"/><path d="m14.063 2.008 4.38 4.38"/><path d="m21.992 9.938-4.38 4.38"/><path d="m9.938 21.992-4.38-4.38"/><path d="M12 3v2"/><path d="M12 19v2"/><path d="M3 12h2"/><path d="M19 12h2"/><path d="m4.929 4.929 1.414 1.414"/><path d="m17.657 17.657 1.414 1.414"/><path d="m4.929 19.071 1.414-1.414"/><path d="m17.657 6.343 1.414-1.414"/></svg>
);
...
export const IconUndo: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M21 14H6.5a4.5 4.5 0 1 1 0-9H14"/><polyline points="10 4 6 8 10 12"/></svg>
);

export const IconRedo: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M3 10h11.5a4.5 4.5 0 1 1 0 9H10"/><polyline points="14 15 18 11 14 7"/></svg>
);
...
export const IconAspectRatio16x9: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><rect x="2" y="5" width="20" height="14" rx="2"/></svg>
);

export const IconAspectRatio9x16: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><rect x="5" y="2" width="14" height="20" rx="2"/></svg>
);

export const IconAspectRatio4x3: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><rect x="3" y="6" width="18" height="12" rx="2"/></svg>
);

export const IconAspectRatio1x1: React.FC<IconProps> = (props) => (
...
export const IconWand: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="m21.64 3.64-1.28-1.28a1.21 1.21 0 0 0-1.71 0L3.31 17.69a1.21 1.21 0 0 0 0 1.71l1.28 1.28a1.21 1.21 0 0 0 1.71 0l15.34-15.34a1.21 1.21 0 0 0 0-1.71z"/><path d="m14 7 3 3"/><path d="M5 6v4"/><path d="M19 14v4"/><path d="M10 2v2"/><path d="M7 8H3"/><path d="M21 16h-4"/><path d="M11 3H9"/><path d="M18 21v-2"/><path d="M16 3h-4"/></svg>
);
